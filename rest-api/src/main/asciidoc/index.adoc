...
operation::create-event[snippets='request-fields,curl-request,http-response,http-request,request-headers,http-response,response-headers,response-body,http-response,links']
...
operation::get-event[snippets='request-fields,curl-request,links']
